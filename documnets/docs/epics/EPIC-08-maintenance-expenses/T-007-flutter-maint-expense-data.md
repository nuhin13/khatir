...
## 1. Feature goal
Typed data layer for maintenance requests + expenses (models, repos, providers).

## 2. Business logic
freezed MaintenanceRequest/Expense; repos: maintenance (list/resolve), expense (CRUD/list/export). Providers.
...
### Manual QA
1. List + resolve + add expense via repos.
