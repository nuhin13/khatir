...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get unit_lease_no_dates => 'Term not set';

  @override
  String get unit_lease_verified => 'NID verified';

  @override
  String get unit_lease_unverified => 'NID not verified';
  ...
  @override
  String get lease_doc_title => 'Smart lease · AI চুক্তি';

  @override
  String get lease_doc_subtitle =>
      'DNCC-সম্মত চুক্তি — AI দিয়ে তৈরি · DNCC-compliant contract generated by AI';

  @override
  String get lease_generate => 'AI দিয়ে চুক্তি তৈরি · Generate AI lease';

  @override
  String get lease_disclaimer =>
      'This is an AI-generated draft and does not constitute legal advice. Please review all clauses with a qualified legal professional before signing.';

  @override
  String get lease_draft_generating => 'AI is generating your lease draft…';

  @override
  String lease_draft_clauses(int count) {
    return '$count clause(s) ready to review';
  }

  @override
  String get lease_clause_required => 'Required';

  @override
  String get lease_edit_clauses => 'Review & edit · ক্লজ সম্পাদনা';

  @override
  String get lease_view_pdf => 'View PDF · PDF দেখুন';

  @override
  String get lease_tier_gated_title => 'Upgrade to use AI lease';

  @override
  String get lease_tier_gated_body =>
      'AI lease generation requires a paid plan. Upgrade to unlock it.';

  @override
  String get lease_unavailable => 'AI lease is not available right now.';

  @override
  String get lease_doc_error =>
      'Could not generate the lease. Please try again.';

  @override
  String get lease_doc_retry => 'Retry · আবার চেষ্টা';

  @override
  String get lease_clause_title => 'Review clauses · ক্লজ যাচাই';

  @override
  String get lease_clause_save => 'Save clauses · সংরক্ষণ';

  @override
  String get lease_clause_save_error =>
      'Could not save clauses. Please try again.';

  @override
  String get lease_clause_saved => 'Clauses saved · সংরক্ষিত';

  @override
  String get lease_clause_edit_hint => 'Edit clause text…';

  @override
  String get lease_clause_required_lock =>
      'Required clause — cannot be deleted';

  @override
  String get lease_pdf_title => 'Lease PDF · চুক্তি PDF';

  @override
  String get lease_pdf_generating => 'Rendering your lease PDF…';

  @override
  String get lease_pdf_error => 'Could not generate the PDF. Please try again.';

  @override
  String get lease_pdf_retry => 'Retry · আবার চেষ্টা';

  @override
  String get lease_pdf_download => 'Download · নামান';

  @override
  String get lease_pdf_share => 'Share · শেয়ার';
  ...
  String get ten_home_star_body =>
      'পরের বাসায় ভালো রেকর্ড পাবেন · Build your rental history';
  ...
  String get ten_pay_pending =>
      'মালিক যাচাই করলে রসিদ পাবেন · Receipt after landlord verifies';
  ...
  String ten_receipts_summary(String count) {
    return '$count মাস পরিশোধিত · $count months paid';
  }
  ...
  String get ten_record_consent =>
      'পরবর্তী মালিককে দেখাতে সম্মত · Share with next landlord';
  ...
  String get ten_record_private_note =>
      'শুধু আপনার সম্মতিতে পরবর্তী মালিক দেখতে পাবেন · Shared only with your per-request consent.';
  ...
  @override
  String get mgr_home_title => 'Manager Home · ম্যানেজার হোম';

  @override
  String get mgr_home_total => 'Total portfolio · মোট পোর্টফোলিও';

  @override
  String mgr_home_owners(String count) {
    return '$count owners · $count মালিক';
  }

  @override
  String get mgr_home_add_owner => 'Add owner · মালিক যোগ';

  @override
  String get mgr_home_team => 'Team · টিম';

  @override
  String get mgr_home_reports => 'Reports · রিপোর্ট';

  @override
  String get mgr_home_empty =>
      'No active owners yet · এখনো কোনো সক্রিয় মালিক নেই';

  @override
  String get mgr_home_empty_sub => 'Link an owner to see their portfolio here.';

  @override
  String get mgr_home_stat_units => 'Units · ইউনিট';

  @override
  String get mgr_home_stat_occupied => 'Occupied · ভাড়া হয়েছে';

  @override
  String get mgr_home_stat_rent => 'Monthly · মাসিক';
  ...
  @override
  String get mgr_add_owner_title => 'Link owner · মালিক যোগ';
  ...
  @override
  String get mgr_add_owner_phone => 'Owner phone · মালিকের নম্বর';

  @override
  String get mgr_add_owner_phone_hint => '01XXXXXXXXX';

  @override
  String get mgr_add_owner_name => 'Owner name · মালিকের নাম';

  @override
  String get mgr_add_owner_name_hint => 'Full name';

  @override
  String get mgr_add_owner_request => 'Send request · অনুরোধ পাঠান';

  @override
  String get mgr_add_owner_pending => 'Pending requests · অপেক্ষমাণ অনুরোধ';

  @override
  String get mgr_add_owner_active => 'Active owners · সক্রিয় মালিক';

  @override
  String get mgr_add_owner_none_pending =>
      'No pending requests · কোনো অপেক্ষমাণ অনুরোধ নেই';

  @override
  String get mgr_add_owner_status_pending => 'Pending · অপেক্ষমাণ';

  @override
  String get mgr_add_owner_status_active => 'Active · সক্রিয়';

  @override
  String get mgr_add_owner_sent => 'Request sent · অনুরোধ পাঠানো হয়েছে';

  @override
  String get mgr_add_owner_error =>
      'Could not send request · অনুরোধ পাঠানো যায়নি';

  @override
  String get mgr_add_owner_err_phone =>
      'Enter a valid phone number · সঠিক নম্বর দিন';

  @override
  String get mgr_add_owner_err_name => 'Enter the owner\'s name · নাম দিন';

  @override
  String get mgr_team_title => 'Team · টিম';

  @override
  String get mgr_team_add => 'Add member · সদস্য যোগ';

  @override
  String get mgr_team_role => 'Role · ভূমিকা';

  @override
  String get mgr_team_scope => 'Scope · পরিসর';

  @override
  String get mgr_team_scope_all => 'All owners · সব মালিক';

  @override
  String get mgr_team_remove => 'Remove · সরান';

  @override
  String get mgr_team_remove_confirm_title => 'Remove member? · সদস্য সরাবেন?';

  @override
  String get mgr_team_remove_confirm_body =>
      'This person will lose access to all owner portfolios.';

  @override
  String get mgr_team_cancel => 'Cancel · বাতিল';

  @override
  String get mgr_team_confirm => 'Remove · সরান';

  @override
  String get mgr_team_empty => 'No team members yet · এখনো কোনো সদস্য নেই';

  @override
  String get mgr_team_add_title => 'Add team member · সদস্য যোগ';

  @override
  String get mgr_team_phone => 'Phone · নম্বর';

  @override
  String get mgr_team_name => 'Name · নাম';

  @override
  String get mgr_team_role_label => 'Role · ভূমিকা';

  @override
  String get mgr_team_added => 'Member added · সদস্য যোগ হয়েছে';

  @override
  String get mgr_team_add_error =>
      'Could not add member · সদস্য যোগ করা যায়নি';

  @override
  String get mgr_team_removed => 'Member removed · সদস্য সরানো হয়েছে';

  @override
  String get mgr_team_remove_error => 'Could not remove · সরানো যায়নি';

  @override
  String get mgr_report_title => 'Reports · রিপোর্ট';

  @override
  String get mgr_report_owner => 'Select owner · মালিক বাছুন';

  @override
  String get mgr_report_generate => 'Generate report · রিপোর্ট তৈরি করুন';

  @override
  String get mgr_report_share => 'Share PDF · PDF শেয়ার';

  @override
  String get mgr_report_no_owners =>
      'No active owners linked · কোনো সক্রিয় মালিক নেই';

  @override
  String get mgr_report_income => 'Income · আয়';

  @override
  String get mgr_report_expense => 'Expense · খরচ';

  @override
  String get mgr_report_net => 'Net · নেট';

  @override
  String get mgr_report_occupancy => 'Occupancy · অকুপেন্সি';

  @override
  String get mgr_report_collection => 'Collection · আদায়';

  @override
  String get mgr_report_generating => 'Generating PDF…';

  @override
  String get mgr_report_pdf_ready => 'PDF ready · PDF তৈরি হয়েছে';

  @override
  String get mgr_report_generate_error =>
      'Could not generate report · রিপোর্ট তৈরি হয়নি';

  @override
  String get mgr_report_share_error => 'Could not share · শেয়ার করা যায়নি';
